...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var minHandBrush = Paint()
      ..shader = RadialGradient(colors: [Color(0xFF6748EF6), Color(0xFF77DDFF)])
    ...
    var centerFillBrush = Paint()..color = Color(0xFFAEACFF);

    var dashBrush = Paint()..color = Color(0xFFAEACFF);
